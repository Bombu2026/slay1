...
export const reviews: Review[] = [
  {
    ...
    rating: 5,
    date: "2024-03-15",
    text: "Incroyable ! La lace est vraiment invisible, même ma meilleure amie n'a pas remarqué. Je recommande à 1000%.",
    productId: "1",
  },
  {
    id: "r2",
    ...
    rating: 5,
    date: "2024-03-10",
    text: "Mon best-seller préféré. Installation en 2 min, je la porte tous les jours depuis 3 mois. Toujours aussi belle.",
    productId: "2",
  },
  {
    id: "r3",
    ...
    rating: 4,
    date: "2024-03-08",
    text: "Les boucles sont magnifiques et tiennent super bien. Juste un peu de shedding au début, puis plus rien.",
    productId: "3",
  },
  {
    id: "r4",
    ...
    rating: 5,
    date: "2024-02-28",
    text: "Le bob parfait ! Tout le monde me fait des compliments. Et pour le prix, c'est un steal.",
    productId: "4",
  },
  {
    id: "r5",
    ...
    rating: 5,
    date: "2024-03-12",
    text: "Cette longueur... je me sens comme une déesse. La qualité est incroyable pour ce prix. Merci Elnacia !",
    productId: "5",
  },
  {
    id: "r6",
    ...
    rating: 5,
    date: "2024-03-01",
    text: "Enfin une perruque qui ressemble vraiment à mes cheveux naturels ! Texture parfaite, confort top.",
    productId: "6",
  },
  {
    id: "r7",
    ...
    rating: 5,
    date: "2024-03-18",
    text: "Vue sur TikTok, commandée, reçue en 3 jours. L'effet water wave est encore plus beau en vrai.",
    productId: "7",
  },
  {
    id: "r8",
    ...
    rating: 4,
    date: "2024-02-20",
    text: "Texture yaki ultra-réaliste. Ma coiffeuse m'a demandé quel produit j'utilisais sur mes cheveux. La meilleure pub !",
    productId: "8",
  },
  {
    id: "r9",
    ...
    rating: 5,
    date: "2024-03-20",
    text: "Je suis convertie. J'en ai déjà 3 dans ma collection Slay. La qualité est constante, jamais déçue.",
    productId: "2",
  },
  {
    id: "r10",
    ...
    rating: 5,
    date: "2024-03-05",
    text: "Livraison rapide, packaging soigné, et la perruque est juste parfaite. C'est ma 2ème commande !",
    productId: "7",
  },
];

export const textures = ["Lisse", "Ondulé", "Bouclé", "Frisé"] as const;
export const lengths = ["Court", "Moyen", "Long"] as const;
export const types = ["Lace Front", "HD Lace", "Glueless"] as const;
